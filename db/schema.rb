...
ActiveRecord::Schema[7.0].define(version: 2023_02_01_171203) do
  ...
  create_table "payments", force: :cascade do |t|
    ...
    t.index ["subscription_type_id"], name: "index_payments_on_subscription_type_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "payment_total", default: false
  ...
  add_foreign_key "payments", "subscription_types"
end
